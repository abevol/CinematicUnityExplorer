...
const toolDefinitions: ToolDefinition[] = [
  ...
  tool("Paralives:get_scene_stats", "paralives_get_scene_stats", "Read cached scene object/component counts; forceRefresh triggers an explicit scene-wide scan. Risk: read-only performance.", getSceneStatsSchema, "performance"),
