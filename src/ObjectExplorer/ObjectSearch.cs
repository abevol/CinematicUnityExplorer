...
namespace UnityExplorer.ObjectExplorer
{
    public class ObjectSearch : UIModel
    {
        ...
        public override void ConstructUI(GameObject parent)
        {
            ...
            Text contextLbl = UIFactory.CreateLabel(contextGroup, "SearchContextLabel", Localizer.Get("LBL_SEARCHING_FOR", Localizer.Get("LBL_SEARCHING_FOR", "Searching for:")), TextAnchor.MiddleLeft);
            ...
            Text unityClassLbl = UIFactory.CreateLabel(classInputRow, "ClassLabel", Localizer.Get("LBL_CLASS_FILTER", Localizer.Get("LBL_CLASS_FILTER", "Class filter:")), TextAnchor.MiddleLeft);
            ...
            Text childLbl = UIFactory.CreateLabel(childFilterRow, "ChildLabel", Localizer.Get("LBL_CHILD_FILTER", Localizer.Get("LBL_CHILD_FILTER", "Child filter:")), TextAnchor.MiddleLeft);
            ...
            Text sceneLbl = UIFactory.CreateLabel(sceneFilterRow, "SceneLabel", Localizer.Get("LBL_SCENE_FILTER", Localizer.Get("LBL_SCENE_FILTER", "Scene filter:")), TextAnchor.MiddleLeft);
            ...
            Text nameLbl = UIFactory.CreateLabel(nameInputRow, "NameFilterLabel", Localizer.Get("LBL_NAME_CONTAINS", Localizer.Get("LBL_NAME_CONTAINS", "Name contains:")), TextAnchor.MiddleLeft);
            ...
            resultsLabel = UIFactory.CreateLabel(resultsCountRow, "ResultsLabel", string.Format(Localizer.Get("LBL_RESULTS_COUNT", "{0} results"), 0), TextAnchor.MiddleCenter);
