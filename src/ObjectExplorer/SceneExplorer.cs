...
namespace UnityExplorer.ObjectExplorer
{
    public class SceneExplorer : UIModel
    {
        ...
        private void PopulateSceneDropdown(List<Scene> loadedScenes)
        {
            ...
            foreach (Scene scene in loadedScenes)
            {
                ...
                if (!scene.IsValid())
                    ...
                    name = Localizer.Get("LBL_UNTITLED", "<untitled>");
        ...
        public override void ConstructUI(GameObject content)
        {
            ...
            Text dropLabel = UIFactory.CreateLabel(dropRow, "SelectorLabel", Localizer.Get("LBL_SCENE_LABEL", Localizer.Get("LBL_SCENE_LABEL", "Scene:")), TextAnchor.MiddleLeft, Color.cyan, false, 15);
            ...
            //Filter input field
            InputFieldRef inputField = UIFactory.CreateInputField(filterRow, "FilterInput", Localizer.Get("LBL_SEARCH_PLACEHOLDER", Localizer.Get("LBL_SEARCH_PLACEHOLDER", "Search and press enter...")));
            ...
            ButtonRef refreshButton = UIFactory.CreateButton(refreshRow, "RefreshButton", Localizer.Get("BTN_UPDATE", Localizer.Get("BTN_UPDATE", "Update")));
            ...
            text.text = Localizer.Get("LBL_AUTO_UPDATE_SEC", Localizer.Get("LBL_AUTO_UPDATE_SEC", "Auto-update (1 second)"));
            ...
            Text nameLabel = UIFactory.CreateLabel(labelsRow, "NameLabel", Localizer.Get("LBL_NAME", Localizer.Get("LBL_NAME", "Name")), TextAnchor.MiddleLeft, color: Color.grey);
            UIFactory.SetLayoutElement(nameLabel.gameObject, flexibleWidth: 9999, minHeight: 25);

            Text indexLabel = UIFactory.CreateLabel(labelsRow, "IndexLabel", Localizer.Get("LBL_SIBLING_INDEX", Localizer.Get("LBL_SIBLING_INDEX", "Sibling Index")), TextAnchor.MiddleLeft, fontSize: 12, color: Color.grey);
        ...
        private static readonly string DEFAULT_LOAD_TEXT = Localizer.Get("LBL_SELECT_SCENE", "[Select a scene]");
        ...
        private void ConstructSceneLoader()
        {
            ...
            try
            {
                if (SceneHandler.WasAbleToGetScenesInBuild)
                {
                    ...
                    Text loaderTitle = UIFactory.CreateLabel(sceneLoaderObj, "SceneLoaderLabel", Localizer.Get("LBL_SCENE_LOADER", Localizer.Get("LBL_SCENE_LOADER", "Scene Loader")), TextAnchor.MiddleLeft, Color.white, true, 14);
                    UIFactory.SetLayoutElement(loaderTitle.gameObject, minHeight: 25, flexibleHeight: 0);

                    // Search filter

                    InputFieldRef searchFilterObj = UIFactory.CreateInputField(sceneLoaderObj, "SearchFilterInput", Localizer.Get("LBL_FILTER_SCENES_PLACEHOLDER", Localizer.Get("LBL_FILTER_SCENES_PLACEHOLDER", "Filter scene names...")));
                    ...
                    loadButton = UIFactory.CreateButton(buttonRow, "LoadSceneButton", Localizer.Get("BTN_LOAD_SINGLE", Localizer.Get("BTN_LOAD_SINGLE", "Load (Single)")), new Color(0.1f, 0.3f, 0.3f));
                    ...
                    loadAdditiveButton = UIFactory.CreateButton(buttonRow, "LoadSceneButton", Localizer.Get("BTN_LOAD_ADDITIVE", Localizer.Get("BTN_LOAD_ADDITIVE", "Load (Additive)")), new Color(0.1f, 0.3f, 0.3f));
