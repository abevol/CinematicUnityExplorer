...
namespace UnityExplorer.UI.Widgets
{
    public class EvaluateWidget : IPooledObject
    {
        ...
        public GameObject CreateContent(GameObject parent)
        {
            ...
            Text genericsTitle = UIFactory.CreateLabel(genericArgumentsHolder, "GenericsTitle", Localizer.Get("LBL_GENERIC_ARGUMENTS", "Generic Arguments"), TextAnchor.MiddleLeft);
            ...
            Text argsTitle = UIFactory.CreateLabel(parametersHolder, "ArgsTitle", Localizer.Get("LBL_ARGUMENTS", "Arguments"), TextAnchor.MiddleLeft);
            ...
            // evaluate button
            ButtonRef evalButton = UIFactory.CreateButton(UIRoot, "EvaluateButton", Localizer.Get("BTN_EVALUATE", "Evaluate"), new Color(0.2f, 0.2f, 0.2f));
