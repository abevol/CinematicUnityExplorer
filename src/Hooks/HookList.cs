...
namespace UnityExplorer.Hooks
{
    public class HookList : ICellPoolDataSource<HookCell>
    {
        ...
        public void SetCell(HookCell cell, int index)
        {
            ...
            cell.ToggleActiveButton.ButtonText.text = hook.Enabled ? Localizer.Get("BTN_ON", Localizer.Get("BTN_ON", "On")) : Localizer.Get("BTN_OFF", Localizer.Get("BTN_OFF", "Off"));
        ...
        internal void ConstructUI(GameObject leftGroup)
        {
            ...
            Text hooksLabel = UIFactory.CreateLabel(UIRoot, "HooksLabel", Localizer.Get("LBL_CURRENT_HOOKS", Localizer.Get("LBL_CURRENT_HOOKS", "Current Hooks")), TextAnchor.MiddleCenter);
