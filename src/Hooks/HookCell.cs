...
namespace UnityExplorer.Hooks
{
    public class HookCell : ICell
    {
        ...
        public GameObject CreateContent(GameObject parent)
        {
            ...
            ToggleActiveButton = UIFactory.CreateButton(UIRoot, "ToggleActiveBtn", Localizer.Get("BTN_ON", "On"), new Color(0.15f, 0.2f, 0.15f));
            ...
            EditPatchButton = UIFactory.CreateButton(UIRoot, "EditButton", Localizer.Get("BTN_EDIT", Localizer.Get("BTN_EDIT", "Edit")), new Color(0.15f, 0.15f, 0.15f));
