...
namespace UnityExplorer.Hooks
{
    public class HookCreator : ICellPoolDataSource<AddHookCell>
    {
        ...
        {
            AddHooksLabel.text = string.Format(Localizer.Get("LBL_ADDING_HOOKS_TO", "Adding hooks to: {0}"), typeText);
        ...
        internal static void SetEditedHook(HookInstance hook)
        {
            ...
            EditingHookLabel.text = string.Format(Localizer.Get("LBL_EDITING_HOOK", "Editing: {0}"), SignatureHighlighter.Parse(hook.TargetMethod.DeclaringType, false, hook.TargetMethod));
        ...
        internal void ConstructAddHooksView(GameObject rightGroup)
        {
            ...
            ClassSelectorInputField = UIFactory.CreateInputField(addRow, "ClassInput", Localizer.Get("TXT_HOOK_CLASS_PLACEHOLDER", Localizer.Get("TXT_HOOK_CLASS_PLACEHOLDER", "Enter a class to add hooks to...")));
            ...
            ButtonRef addButton = UIFactory.CreateButton(addRow, "AddButton", Localizer.Get("BTN_VIEW_METHODS", Localizer.Get("BTN_VIEW_METHODS", "View Methods")));
            ...
            AddHooksLabel = UIFactory.CreateLabel(AddHooksRoot, "AddLabel", Localizer.Get("LBL_CHOOSE_CLASS_BEGIN", Localizer.Get("LBL_CHOOSE_CLASS_BEGIN", "Choose a class to begin...")), TextAnchor.MiddleCenter);
            UIFactory.SetLayoutElement(AddHooksLabel.gameObject, minHeight: 30, minWidth: 100, flexibleWidth: 9999);

            AddHooksMethodFilterInput = UIFactory.CreateInputField(AddHooksRoot, "FilterInputField", Localizer.Get("TXT_FILTER_METHODS_PLACEHOLDER", Localizer.Get("TXT_FILTER_METHODS_PLACEHOLDER", "Filter method names...")));
        ...
        public void ConstructEditor(GameObject parent)
        {
            ...
            Text editorLabel = UIFactory.CreateLabel(EditorRoot,
                "EditorLabel",
                Localizer.Get("TXT_HOOK_EDITOR_INSTRUCTIONS",
            ...
            ButtonRef editorSaveButton = UIFactory.CreateButton(editorButtonRow, "DoneButton", Localizer.Get("BTN_SAVE_AND_RETURN", Localizer.Get("BTN_SAVE_AND_RETURN", "Save and Return")), new Color(0.2f, 0.3f, 0.2f));
            ...
            ButtonRef editorDoneButton = UIFactory.CreateButton(editorButtonRow, "DoneButton", Localizer.Get("BTN_CANCEL_AND_RETURN", Localizer.Get("BTN_CANCEL_AND_RETURN", "Cancel and Return")), new Color(0.2f, 0.2f, 0.2f));
